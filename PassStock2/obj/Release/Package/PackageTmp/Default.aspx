        ...
        <ContentTemplate>--%>
            <div class="jumbotron">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <asp:Button ID="insert_data_btn" runat="server" CssClass="btn btn-link btn-block"
                            Text="เพิ่มข้อมูล" onClick="insertdata_view_click" />
                        <%--                        <a class="nav-link active" data-toggle="tab" href="#insert_data" runat="server"
                            onclick="insert_data_click">เพิ่มข้อมูล</a>--%>
                    </li>
                    <li class="nav-item">
                        <asp:Button ID="select_count1_btn" runat="server" CssClass="btn btn-link btn-block"
                            Text="แสดงข้อมูล" onClick="select_count1_click" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="margin : 30px;">
                                                <asp:LinkButton ID="LinkButton1" runat="server"
                                                    OnClick="selectData1_Button_Click"
                                                    CssClass="btn btn-success btn-lg">
...
<%--                                <div class="card">
                                    <div class="card-body">
                                        <div class="date-stock">
                                            <div style="margin : 30px;">
                                                <asp:LinkButton ID="selectData1_Button" runat="server"
                                                    OnClick="selectData1_Button_Click"
                                                    CssClass="btn btn-success btn-lg">
                                                    <i class="fas fa-list"></i> แสดงข้อมูล
                                                </asp:LinkButton>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12" style="padding-top: 20px">
                                    <asp:GridView ID="dataStock" BorderWidth="0" GridLines="None" runat="server"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="รหัสอะไหล่" HeaderStyle-CssClass="txt_GridView">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("ID_Item") %>'
                                                        CssClass="txt_GridView"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="ชื่ออะไหล่" HeaderStyle-CssClass="txt_GridView">
                                                <ItemTemplate>
...
<%--                                            <asp:TemplateField HeaderText="หมวดอะไหล่" HeaderStyle-CssClass="txt_GridView">
                                            ...
                                            <asp:TemplateField HeaderText="ชั้นวางหลัก" HeaderStyle-CssClass="txt_GridView">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server"
                                           ...
                                           <%-- <asp:TemplateField HeaderText="ราคาขายต่อหน่วย" HeaderStyle-CssClass="txt_GridView">
                                            ...
                                            <asp:TemplateField HeaderText="ราคาขายทั้งหมด" HeaderStyle-CssClass="txt_GridView">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server"
                                            ...
                                            <asp:TemplateField HeaderText="ต้นทุนขายต่อหน่วย" HeaderStyle-CssClass="txt_GridView">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server"
                                            ...
                                            <asp:TemplateField HeaderText="ต้นทุนขายทั้งหมด" HeaderStyle-CssClass="txt_GridView">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server"
                                            ...
                                            <asp:TemplateField HeaderText="สต๊อกรวม" HeaderStyle-CssClass="txt_GridView">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server"
...
<%--                                            <asp:TemplateField HeaderText="จำนวนการจอง" HeaderStyle-CssClass="txt_GridView">
                                            ...
                                            <asp:TemplateField HeaderText="สต๊อกเดือนที่ผ่านมา" HeaderStyle-CssClass="txt_GridView">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server"
                                            ...
                                            <asp:TemplateField HeaderText="แตกต่าง" HeaderStyle-CssClass="txt_GridView">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server"
                                                        Text='<%# Bind("Count_Value") %>'
                                                        CssClass="txt_GridView">
                                                    </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="ต้นทุนที่แตกต่าง" HeaderStyle-CssClass="txt_GridView">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server"
                                                        Text='<%# Bind("Cost_Count_Value") %>'
                                                        CssClass="txt_GridView">
                                                    </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
